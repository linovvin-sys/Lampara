...
if (!file_exists($secretsPath)) {
    echo json_encode(['success' => false, 'reply' => "(setup needed) Copy Backend/secrets.example.php to Backend/secrets.php and add your Gemini key — see the Lampara README."]);
    exit;
}
